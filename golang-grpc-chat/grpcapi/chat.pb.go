...
const file_chat_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"chat.proto\x12\agrpcapi\"Y\n" +
	"\vChatMessage\x12\x12\n" +
	"\x04user\x18\x01 \x01(\tR\x04user\x12\x18\n" +
	"\acontent\x18\x02 \x01(\tR\acontent\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp2E\n" +
	"\vChatService\x126\n" +
	"\x04Chat\x12\x14.grpcapi.ChatMessage\x1a\x14.grpcapi.ChatMessage(\x010\x01B\x1aZ\x18golang-grpc-chat/grpcapib\x06proto3"
...
var file_chat_proto_goTypes = []any{
	(*ChatMessage)(nil), // 0: grpcapi.ChatMessage
}
var file_chat_proto_depIdxs = []int32{
	0, // 0: grpcapi.ChatService.Chat:input_type -> grpcapi.ChatMessage
	0, // 1: grpcapi.ChatService.Chat:output_type -> grpcapi.ChatMessage
